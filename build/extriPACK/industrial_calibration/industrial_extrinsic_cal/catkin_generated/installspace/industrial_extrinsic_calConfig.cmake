...
if(NOT "include;/usr/include;/usr/local/include;/usr/include/eigen3 " STREQUAL " ")
  set(industrial_extrinsic_cal_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/usr/local/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_extrinsic_cal' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_ws/install/${idir}'.  ${_report}")
    endif()
