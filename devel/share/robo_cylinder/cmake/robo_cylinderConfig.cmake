...
if("TRUE" STREQUAL "TRUE")
  set(robo_cylinder_SOURCE_PREFIX /home/casch/yumi_ws/src/extriPACK/intelligent_actuator/robo_cylinder)
...
if(NOT "/home/casch/yumi_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robo_cylinder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_ws/src/extriPACK/intelligent_actuator/robo_cylinder/${idir}'.  ${_report}")
    endif()
