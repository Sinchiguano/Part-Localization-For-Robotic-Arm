...
if("TRUE" STREQUAL "TRUE")
  set(rgbd_depth_correction_SOURCE_PREFIX /home/casch/yumi_ws/src/industrial_calibration/rgbd_depth_correction)
...
if(NOT "/usr/include;/usr/local/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rgbd_depth_correction' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_ws/src/industrial_calibration/rgbd_depth_correction/${idir}'.  ${_report}")
    endif()
