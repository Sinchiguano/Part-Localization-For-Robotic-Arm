...
if("TRUE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX /home/casch/yumi_ws/src/caliPACK/image_common/camera_calibration_parsers)
...
if(NOT "/home/casch/yumi_ws/src/caliPACK/image_common/camera_calibration_parsers/include " STREQUAL " ")
  set(camera_calibration_parsers_INCLUDE_DIRS "")
  set(_include_dirs "/home/casch/yumi_ws/src/caliPACK/image_common/camera_calibration_parsers/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_ws/src/caliPACK/image_common/camera_calibration_parsers/${idir}'.  ${_report}")
    endif()
