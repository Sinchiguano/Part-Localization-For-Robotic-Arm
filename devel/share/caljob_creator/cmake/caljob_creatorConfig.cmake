...
if("TRUE" STREQUAL "TRUE")
  set(caljob_creator_SOURCE_PREFIX /home/casch/yumi_ws/src/industrial_calibration/caljob_creator)
...
if(NOT "/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'caljob_creator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_ws/src/industrial_calibration/caljob_creator/${idir}'.  ${_report}")
    endif()
